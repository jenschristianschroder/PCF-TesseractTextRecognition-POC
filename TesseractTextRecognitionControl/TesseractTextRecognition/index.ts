...
export class TesseractTextRecognition implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	{
		return {
			recognizedText : this._recognizedText
		};
	}
